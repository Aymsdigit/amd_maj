<!-- Navbar -->
<nav class="navbar navbar-main navbar-light mt-3 navbar-fixed navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl"
            ...
            <ul class="navbar-nav  justify-content-end">
                <li class="nav-item d-flex align-items-center">
                    <a href="<?= base_url()?>/pages/sign-in.html" class="nav-link text-body font-weight-bold px-0">
                        ...
                        <span class="d-sm-inline d-none">Se connecter</span>
                    </a>
                </li>
